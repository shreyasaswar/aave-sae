...
def calculate_and_save_bleu(model, dataset, filename='translation_results_M1.csv'):
    results = []
    bleu_scores = []
...
best_model.save('best_model_M1.h5')  # Save the full model in HDF5 format

print("Best model saved as 'best_model_M1.h5'")